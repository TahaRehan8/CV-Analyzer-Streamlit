...
Designed for simplicity, speed, and absolute privacy, the app features a streamlined **single-file architecture** specifically optimized for instant deployment to **Streamlit Community Cloud**.
...
*   **🤖 Smart Semantic Matching**: Powered by Gemini (`gemini-2.5-flash` or `gemini-2.0-flash`), the system uses advanced semantic understanding. It handles synonyms (e.g. recognizing "React.js" matches "React") and balances core vs. nice-to-have requirements fairly.
